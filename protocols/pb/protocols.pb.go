...
var file_protocols_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
...
var file_protocols_proto_depIdxs = []int32{
	...
	26, // 15: pb.ClientOracleUpdate.price_update:type_name -> pb.ClientPriceUpdate
	27, // 16: pb.ClientOracleUpdate.fee_rate_update:type_name -> pb.ClientFeeRateUpdate
